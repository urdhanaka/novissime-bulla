...
\lstinputlisting[
  language=Go,
  caption={Prosedur Pembuatan \emph{Control Plane} pada Komputer \emph{Worker} Bagian 1},
  label={lst:isi-prosedur-1}
]{program/rpc-procedure-logic-master.go}

\lstinputlisting[
  language=Go,
  caption={Prosedur Pembuatan \emph{Control Plane} pada Komputer \emph{Worker} Bagian 2},
  label={lst:isi-prosedur-2}
]{program/rpc-procedure-logic-worker.go}
